...
namespace Weathering
{
    public class MapOfGalaxy : StandardMap
    {
        ...
        public const long DefaultInventoryQuantityCapacity = 1000000000000;
        public const int DefaultInventoryTypeCapacity = 30;
        ...
        public override void OnEnable() {
            base.OnEnable();
            if (Inventory.QuantityCapacity < DefaultInventoryQuantityCapacity) {
                Inventory.QuantityCapacity = DefaultInventoryQuantityCapacity;
            }
            if (Inventory.TypeCapacity < DefaultInventoryTypeCapacity) {
                Inventory.TypeCapacity = DefaultInventoryTypeCapacity;
            }
        }
