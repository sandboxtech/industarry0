...
namespace Weathering
{
    ...
    public abstract class AbstractWareHouse : StandardTile, ILinkConsumer, ILinkProvider, ILinkEvent, IPassable, IStepOn
    {
        ...
        public override string SpriteKeyHighLight { get => (ValueOfResource.Inc != 0 || ValueOfResource.Val > 0) ? GlobalLight.Decorated(SpriteKey) : null; }
        ...
        public override void OnEnable() {
            ...
            if (TypeOfResource.X == 0) { TypeOfResource.X = 1; } // fix
        }
        ...
        public override void OnTap() {
            ...
            items.Add(UIItem.CreateButton($"改变仓库运行模式, 当前模式为: {CalcWareHouseModeDescription(WareHouseMode)}", SetWareHouseModePage));
