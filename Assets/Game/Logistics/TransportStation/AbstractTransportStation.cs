...
namespace Weathering
{
    ...
    public abstract class AbstractTransportStation : StandardTile, ILinkEvent, ILinkConsumer, IRunnable, IPassable
    {
        ...
        public bool Running { get => RefOfDelivery.Y == 1; set {
                if (ToUniverse) {
                    Map.Refs.GetOrCreate<ToUniverseCount>().Value += value ? 1 : -1;
                }
                RefOfDelivery.Y = value ? 1 : 0;
            } 
        }
        ...
        public void Run() {
            ...
            RefOfDelivery.X = RefOfDelivery.Value; // 实际运输量
            ...
            TargetInventory.Add(RefOfDelivery.Type, RefOfDelivery.X);
        }
        public bool CanRun() {
            ...
            if (!TargetInventory.CanAdd((RefOfDelivery.Type, RefOfDelivery.X))) { // 背包装不下
        ...
        public void Stop() {
            ...
            TargetInventory.Remove(RefOfDelivery.Type, RefOfDelivery.X);

            RefOfDelivery.BaseValue = Capacity;
            RefOfDelivery.Value = RefOfDelivery.X;
            RefOfDelivery.X = 0;
            Running = false;
            NeedUpdateSpriteKeys = true;
        }
        public bool CanStop() {
            ...
            if (!TargetInventory.CanRemove((RefOfDelivery.Type, RefOfDelivery.X))) return false; // 背包里没有送出去的物品
        ...
        public override void OnTap() {
            ...
            string itemName = RefOfDelivery.Type == null ? "" : Localization.Ins.ValPlus(RefOfDelivery.Type, RefOfDelivery.X);
