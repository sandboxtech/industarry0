...
namespace Weathering
{
    ...
    public abstract class AbstractRoad : StandardTile, ILinkConsumer, ILinkProvider, ILinkQuantityRestriction, ILinkEvent, ILinkTypeRestriction, IPassable, IWalkingTimeModifier
    {
        ...
        public override string SpriteKeyRoad {
            get {
                int index = TileUtility.Calculate4x4RuleTileIndex(this, (tile, direction) => 
                    Refs.Has(direction) || 
                    ((RoadRef.Type == null) && (tile is AbstractRoad) && (tile as AbstractRoad).RoadRef.Type == null && LinkUtility.SatisfyLinkTileTypeRestriction(tile, this))
                );
        ...
        public virtual long LinkQuantityRestriction { get => RoadQuantityRestriction; }
