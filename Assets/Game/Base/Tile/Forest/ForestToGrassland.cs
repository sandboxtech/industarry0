...
//    {
//        public override string SpriteKey => typeof(ForestToGrassland).Name;
...
//                , new InventoryQueryItem { Quantity = 1, Type = typeof(Food), Source = Map.Inventory, Target = Inventory }
