    ...
    public class UI : MonoBehaviour, IUI
    {
        ...
        private BarImage CreateBarImage(string content = null, Func<string> dynamicContent = null,
            ...
            if (useSeparator) {
                ...
                if (dynamicContent != null) sprite = sprite == null ? Res.Ins.TryGetSprite(dynamicContent()) : sprite;
            }
            if (sprite == null && dynamicContent == null) return null;
        ...
        private ProgressBar CreateProgressBar(bool sliderOrProgress) {
            ...
            result.Foreground.color = sliderOrProgress ? semiTransparentColor : new Color(value, value, value, value);
            result.Background.color = sliderOrProgress ? semiTransparentColor : new Color(value, value, value, value);
        ...
        private ProgressBar CreateSlider(Func<float, string> dynamicSlider, float initialValue = 0) {
            ProgressBar result = CreateProgressBar(true);
        ...
        private ProgressBar CreateValueProgress(IValue value, string barTitle = "") {
            ProgressBar result = CreateProgressBar(false);
        ...
        private void Update() {
            ...
            foreach (var pair in dynamicImage) {
                string name = pair.Value.Invoke();
                pair.Key.RealImage.sprite = Res.Ins.TryGetSprite(name);
            }
